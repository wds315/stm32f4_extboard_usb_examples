...
int main(void)
{
  ...
  */  
  ...
  SerialPutString(" \r\n");
  SerialPutString(" \r\n");
  SerialPutString("USB_HOST_DEVICE  USB Manual Dual role device example\r\n");
  SerialPutString("Press keys 1,2,3 in HyperTerminal to Select demo. \r\n");
  SerialPutString("keys 1  :  Up\r\n");
  SerialPutString("keys 2  :  Down\r\n");
  SerialPutString("keys 3  :  Select\r\n");
  SerialPutString(" \r\n");
  SerialPutString(" \r\n");
  SerialPutString("####################################################\r\n");
